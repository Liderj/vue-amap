...
<div id="demoComponent" class="demo-component">
    <amap id="amap" :zoom="zoom" :center="center">
      <amap-polyline v-for="polyline in polylines" :path="polyline.path" :events="polyline.events"></amap-polyline>
    </amap>
  </div>
</div>
```
...
export default {
  ...
  data () {
    return {
      ...
      polylines: [
        {
          path: [[121.5273285, 31.21515044], [121.5389385, 31.21515044], [121.5389385, 31.29615044]],
          events: {
            click(e) {
